...
public class GyrometerView extends View {
	...
	public GyrometerView(Context context, AttributeSet ats, int defaultStyle) {
	...
	protected void initCompassView() {
		...
		circlePaint.setColor(R.color.gyrometer_background_color);
		circlePaint.setStrokeWidth(1);
		circlePaint.setStyle(Paint.Style.STROKE);

		textPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
		textPaint.setColor(r.getColor(R.color.gyrometer_text_color));
		...
		markerPaint.setColor(r.getColor(R.color.gyrometer_marker_color));
		markerPaint.setAlpha(200);
		markerPaint.setStrokeWidth(1);
		markerPaint.setStyle(Paint.Style.STROKE);
		markerPaint.setShadowLayer(2.0f, 1.0f, 1.0f,
				r.getColor(R.color.shadow_color));
	...
	protected void onDraw(Canvas canvas) {
		...
		// Eclipse fails to render with outerRingPath, comment to see
		// GyrometerView in Eclipse
