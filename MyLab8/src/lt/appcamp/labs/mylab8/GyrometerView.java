...
protected void initCompassView() {
    ...
    markerPaint.setShadowLayer(2.0f, 1.0f, 1.0f, r.getColor(R.color.shadow_color));
  ...
  protected void onDraw(Canvas canvas) {
    ...
    //Eclipse fails to render with outerRingPath, comment to see GyrometerView in Eclipse
